...
The **EvoFarm Documentation Assistant** is a RAG service built to answer natural-language questions about the [EvoFarm](https://evofarm.vercel.app) distributed optimization platform.
...
For an existing PostgreSQL volume, initialize the schema manually if necessary:
...
The assistant is built specifically to support documentation for [EvoFarm](https://evofarm.vercel.app).
